...
RSpec.describe ShoutsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all shouts as @shouts" do
      ...
      expect(assigns(:shouts)).to eq([shout])
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created shout as @shout" do
        ...
        expect(assigns(:shout)).to be_persisted
      end

      it "redirects to the created shout" do
        post :create, {:shout => valid_attributes}, valid_session
        expect(response).to redirect_to(Shout.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved shout as @shout" do
        post :create, {:shout => invalid_attributes}, valid_session
        expect(assigns(:shout)).to be_a_new(Shout)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested shout" do
        shout = Shout.create! valid_attributes
        put :update, {:id => shout.to_param, :shout => new_attributes}, valid_session
        shout.reload
      ...
      it "redirects to the shout" do
        shout = Shout.create! valid_attributes
        put :update, {:id => shout.to_param, :shout => valid_attributes}, valid_session
        expect(response).to redirect_to(shout)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the shout as @shout" do
        shout = Shout.create! valid_attributes
        put :update, {:id => shout.to_param, :shout => invalid_attributes}, valid_session
        expect(assigns(:shout)).to eq(shout)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the shouts list" do
      shout = Shout.create! valid_attributes
      delete :destroy, {:id => shout.to_param}, valid_session
      expect(response).to redirect_to(shouts_url)
    end
  end
